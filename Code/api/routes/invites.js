			...
			.then(function(ret) {
				...
				db.user.findById(email.userId).then(function (user) {
					...
					var script = '<script type="text/javascript">' +
						...
						(user.title ? 'localStorage.setItem("title", ' + JSON.stringify(user.title) +');' : 'localStorage.removeItem("title");') +
						(user.affiliation ? 'localStorage.setItem("affiliation", ' + JSON.stringify(user.affiliation) +');' : 'localStorage.removeItem("affiliation");') +
